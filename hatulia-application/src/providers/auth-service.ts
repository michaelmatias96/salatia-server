...
export class AuthService {
  ...
  auth0 = new Auth0({clientID: 'm1NOCEkfL6jZYZLBjvgbzaIFaKg0bK18', domain: 'michaelmatias.auth0.com'});
  lock = new Auth0Lock('m1NOCEkfL6jZYZLBjvgbzaIFaKg0bK18', 'michaelmatias.auth0.com', {
    auth: {
      redirect: false,
      params: {
